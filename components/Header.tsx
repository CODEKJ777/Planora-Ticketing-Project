      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 sm:gap-3">
          <motion.div 
            ...
            whileTap={{ scale: 0.98 }} 
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-navy-800 to-grad-end flex items-center justify-center text-white font-bold shadow-lg text-sm sm:text-base"
          >
            ET
          </motion.div>
          <div className="hidden sm:block">
            <div className="text-base sm:text-lg font-medium leading-none text-white">Planora</div>
            <div className="text-xs text-strong-accent flex items-center gap-2"> 
              <span className="px-2 py-0.5 text-[10px] rounded-full bg-white/6 text-strong">PLANORA</span>
            </div>
          </div>
        </Link>

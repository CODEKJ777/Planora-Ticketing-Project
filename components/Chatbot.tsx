...
export default function Chatbot() {
  ...
  async function sendMessage(textOverride?: string) {
    ...
    const userMsg: Message = { id: nextMessageId(), role: 'user', text, timestamp: new Date() }
    ...
    try {
      ...
      if (res.ok) {
        ...
        setIsTyping(false)
        const botReply: Message = { id: nextMessageId(), role: 'bot', text: data.text, timestamp: new Date() }
    ...
    setIsTyping(false)
    const botReply: Message = { id: nextMessageId(), role: 'bot', text: resp.text, timestamp: new Date() }
    setMessages(prev => [...prev, botReply])

    ...
    <div className="min-h-screen p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-400">Verify your email to view and download your tickets</p>
        </div>

        <div className="card p-8 bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 border border-violet-500/20 backdrop-blur-xl">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">Enter your email to receive a one-time password</p>
              </div>
            </div>
        ...
        {lookupResults.length > 0 && (
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">Your Tickets</h3>
            <div className="grid gap-4">
              {lookupResults.map(t => (
                <motion.div 
                  ...
                  className="card p-6 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 hover:border-blue-500/40 transition-all"
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-slate-300 text-sm">{t.email}</div>
                        </div>
                      </div>
                      {t.college && (
                    ...
                    <div className="flex gap-3">
                      <Link 
                        className="px-6 py-3 bg-blue-500/20 hover:bg-blue-500/30 text-blue-200 font-medium rounded-lg transition-all flex items-center gap-2"
                        href={`/ticket/${t.id}`}
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <a 
                        className="px-6 py-3 bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600 text-white font-medium rounded-lg transition-all flex items-center gap-2"
